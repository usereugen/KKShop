        ...
        <>
            ...
            <div className="header-bottom">
                <div className="container-header-top">
                    ...
                    <div className="flex">
                            <svg className="mr-[10px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <svg className="mr-[10px]" xmlns="http://www.w3.org/2000/svg" width="18" height="21"
                            ...
                            <svg className="mr-[10px]" xmlns="http://www.w3.org/2000/svg" width="21" height="22"
